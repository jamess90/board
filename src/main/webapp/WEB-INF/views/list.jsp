...
<%
	...
	int num = BDao.getinstance().count_rows("list");
	int total_record = num;	   //현재 페이지
	//int total_record = 100;		   //현재 페이지
...
<body> 
    ...
    <table width="960" cellpadding="1" cellspacing="1" border="2">
        ...
        <c:forEach items="${list}"  begin = "<%=record_start_no-1%>" end = "<%=record_end_no-1%>" var="dto">
        <tr>
            <td>${dto.bNum}</td>
            <td>
...
　　　　　　　　　　　　　　　　　　　
<a href="list?pageno=1">[＜＜]</a>
<a href="list?pageno=<%=prev_pageno%>">[＜]</a> 
...
<a href="list?pageno=<%=next_pageno%>" >[＞]</a>
<a href="list?pageno=<%=total_page %>">[＞＞]</a><br>
